...
export const participationScenarios: ParticipationScenario[] = [
  { name: "server nickname reaction request after human mention", expected: [{ action: "react", messageId: "3", emoji: "👍" }], messages: [m("1", "bot", "Shared chat now uses Jev to choose whether to reply, react, or stay quiet."), m("2", "alice", "<@bob> Take a look at this."), m("3", "alice", "Now it will only reply when it makes sense. Rook react to this message if you understand")] },
  { name: "username reaction request", expected: [{ action: "react", messageId: "2", emoji: "👍" }], messages: [m("1", "bot", "Shared chat can reply, react, or stay quiet."), m("2", "alice", "AI Assistant react to this message if you understand")] },
  ...
  { name: "requested custom celebration", availableEmojis: [{ value: "👍", name: "👍" }, { value: "123456789012345678", name: "party_parrot" }], expected: [{ action: "react", messageId: "1", emoji: "123456789012345678" }], messages: [m("1", "alice", "Rook, react with :party_parrot: to celebrate!")] },
  ...
  { name: "reaction during cooldown", reactionCooldown: true, expectedActivity: false, expected: [{ action: "ignore" }, { action: "react", messageId: "1", emoji: "👍" }], messages: [m("1", "alice", "Rook, react with a thumbs up if you understand.")] },
];
