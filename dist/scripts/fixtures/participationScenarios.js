...
const customChoices = ["party_parrot", "dancing_otter", "tiny_dragon", "happy_blob", "confetti_cat", "waving_penguin", "smug_fox", "starry_frog"]
    .map((name, i) => ({ name, value: String(123456789012345678n + BigInt(i)), custom: true }));
const reactionCatalog = [{ value: "👍", name: "👍", custom: false }, { value: "👀", name: "👀", custom: false }, ...customChoices];
