...
export const RULESET_TOOLS = [
    {
        ...
        inputSchema: { type: "object", properties: { run_id: runProperty, user: userProperty, include_disabled: { type: "string", enum: ["true", "false"] } }, required: ["run_id", "user"], additionalProperties: false },
    },
    {
        name: "get_user_ruleset",
        description: "Get one named ruleset for a Discord user in the current server.",
        inputSchema: { type: "object", properties: { run_id: runProperty, user: userProperty, name: nameProperty }, required: ["run_id", "user", "name"], additionalProperties: false },
    },
    {
        ...
        inputSchema: { type: "object", properties: { run_id: runProperty, user: userProperty, name: nameProperty, instructions: instructionsProperty, priority: { type: "string" } }, required: ["run_id", "user", "instructions"], additionalProperties: false },
    },
    {
        name: "append_user_ruleset",
        description: "Append instructions to an existing ruleset for a Discord user.",
        inputSchema: { type: "object", properties: { run_id: runProperty, user: userProperty, name: nameProperty, instructions: instructionsProperty }, required: ["run_id", "user", "name", "instructions"], additionalProperties: false },
    },
    {
    ...
    },
    {
        ...
        inputSchema: { type: "object", properties: { run_id: runProperty, user: userProperty }, required: ["run_id", "user"], additionalProperties: false },
    },
    {
