...
export const commands = [
    ...
    new SlashCommandBuilder()
        ...
        .addSubcommand((sub) => sub.setName("list").setDescription("List supported reasoning effort levels"))
        .addSubcommand((sub) => sub
        .setName("set")
    ...
    new SlashCommandBuilder()
        ...
        .addSubcommand((sub) => sub.setName("list").setDescription("List all available providers"))
        .addSubcommand((sub) => sub
        .setName("set")
        ...
        .setRequired(true)))
        .addSubcommand((sub) => sub.setName("current").setDescription("Show the active provider for this session")),
    new SlashCommandBuilder()
        .setName("agent")
