...
export const commands = [
  new SlashCommandBuilder()
    ...
    .addAttachmentOption((opt) =>
      opt
        .setName("image")
        .setDescription("An image for the AI to analyze as context")
        .setRequired(false)
    ),

  new SlashCommandBuilder()
    .setName("chat")
    .setDescription("Chat with the AI using persistent session history")
    .addStringOption((opt) =>
      opt
        .setName("message")
  ...
  new SlashCommandBuilder()
    .setName("reset")
    .setDescription("Clear your AI session history"),
  ...
  new SlashCommandBuilder()
    .setName("status")
    .setDescription("Show AI auth status and CLI version"),
  ...
  new SlashCommandBuilder()
    .setName("reasoning")
    .setDescription("Manage reasoning effort for your session")
    .addSubcommand((sub) =>
      sub.setName("list").setDescription("List supported reasoning effort levels")
    )
    .addSubcommand((sub) =>
      sub
        .setName("set")
        .setDescription("Set reasoning effort for the next turn")
        .addStringOption((opt) =>
          opt
            .setName("effort")
    ...
    .addSubcommand((sub) =>
      sub.setName("current").setDescription("Show the current reasoning effort")
    ),

  new SlashCommandBuilder()
    .setName("provider")
    .setDescription("List, switch, or show the active AI provider for your session")
    .addSubcommand((sub) =>
      sub.setName("list").setDescription("List all available providers")
    )
    .addSubcommand((sub) =>
      sub
        .setName("set")
        .setDescription("Switch the active provider for this session")
        .addStringOption((opt) =>
          opt
            .setName("provider")
            .setDescription("Provider name (copilot | codex | opencode)")
            .setRequired(true)
        )
    )
    .addSubcommand((sub) =>
      sub.setName("current").setDescription("Show the active provider for this session")
    ),
